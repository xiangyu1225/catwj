...
<head>
    ...
    <style>
        .ios .ktb1-detailPage .box .top-pic p {
            font-size: 16px;
            padding: 10px 0;
            line-height: 34px;
        }

        .ktb1-detailPage .box .top-pic span {
            float: right;
            color: #000;
            font-weight: bold;
            margin-right: 18px;
        ...
        .ktb1-detailPage .box .top-pic p {
            color: #000;
            font-weight: bold;
        }

        .ios .ktb1-detailPage .box span {
            font-size: 16px
        }
    </style>
    <script>
...
<script>!!core && core.factory('ktb1DetailPage')</script>

<!-- Google Tag Manager -->
<noscript>
    <iframe src="//www.googletagmanager.com/ns.html?id=GTM-N6KR6R"
