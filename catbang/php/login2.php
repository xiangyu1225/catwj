...
if ($action == "login") {
    ...
    $args = array("strInfo" => "<Cat><UserInfo><Name>" . $userName . "</Name><Mobile>" . $mobile . "</Mobile><DataSource>" . $datasource . "</DataSource><UtmSource>" . $utmSource . "</UtmSource><UtmMedium>" . $utmMedium . "</UtmMedium><UtmCampaign>" . $utmCampaign . "</UtmCampaign><UtmContent>" . $utmContent . "</UtmContent><UtmTerm>" . $utmTerm . "</UtmTerm></UserInfo></Cat>", "strToken" => $strToken);
