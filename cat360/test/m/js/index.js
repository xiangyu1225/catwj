        ...
        dataHandle: {
            ...
            getProductDetail: function (params, success) {
                $.ajax({
                    'type': 'get',
                    'dataType': 'json',
                    'url': SITE_API_URL + 'getproductdetails.php',
                    'data': params,
                    'success': function (data) {
                        if (data && data.ErrorCode == 0) {
                            func(data);
            ...
            register: function (mobile, userName) {
                ...
                $.ajax({
                    ...
                    // 'dataType': 'json',
                    // 'url': testLogin,
                    // 'url': 'http://www.catwj.cn/Interface/Add_360Advantage?sj='+ Math.random(),
                    'url': 'http://cattest.hnqxs.com/Interface/Add_360Advantage?sj='+ Math.random(),
                    'type': "GET",
                    'data': params,
                    // cache:false,  
                    // 'dataType': "jsonp",
                    // 'jsonp': "callback", //这里定义了callback的参数名称，以便服务获取callback的函数名即getMessage  
                    // 'jsonpCallback': "getMessageMessage", //这里定义了jsonp的回调函数
        ...
        $('.top-menu').on('click', function () {
            ...
            if (core.userInfo.UserID) {//已登录
                $('header').append('<ul class="menu-list"><li><a href="javascript:;" class="user"><img src="img/btn-name.png" alt="" class="btn-name"><em>' + core.userInfo.Name + '</em></a><img src="img/btn-logout.png" alt="" class="btn-logout"></li><li><a href="javascript:;" class="link-catbang-user"><img src="img/btn-userInfo.png" alt="" style="margin-left: 16px"><strong style="margin-left: -10px" >卡特帮个人中心</strong></a></li>' +
                    ...
                    '<p class="btn-360"><strong>CAT360°优利客户尊享套餐</strong><br><span >立即点击了解详情&gt;&gt;</span></p></a></li>' +
                    '<li><a class="item"><img src="img/fuel-icon.png" style="margin-left: 16px">' +
...
function alert (str,callback,autoclse) {
        var timer = null
